...
function html_get_body()
{
    ...
    function html_get_td_logo()
    {
        ...
        r += '<div id="div_logo"><img id="img_logo" src="' + IMG.LOGO_DONE +
            '"></div>\n';
    ...
    function html_get_td_auth()
    {
        ...
        r +=
            '<button id="button_pheno" onclick="wid_open_email_window()">' +
            B_TXT.PHENO + '</button>\n';
        r +=
            '<button id="button_google" onclick="wid_auth(\'google\')">' +
            B_TXT.GOOGLE + '</button>\n';
        r +=
            '<button id="button_facebook" onclick="wid_auth(\'facebook\')">' +
            B_TXT.FACEBOOK + '</button>\n';
        r +=
            '<button id="button_linkedin" onclick="wid_auth(\'linkedin\')">' +
            B_TXT.LINKEDIN + '</button>\n';
        r +=
            '<button id="button_windows" onclick="wid_auth(\'windows\')">' +
    ...
    function html_get_td_cmd_prompt()
    {
        ...
        r +=
            '<textarea id="cmd_prompt" style="width: 100%; height: 10em">' +
            '</textarea>';
...
function html_get_td_cmd_prompt()
{
    ...
    r += '<textarea id="cmd_prompt" style="width: 100%; height: 10em">' +
        '</textarea>';
